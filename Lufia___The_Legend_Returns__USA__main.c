/* Main entry point */
#include "Lufia___The_Legend_Returns__USA_.h"
#include "gbrt.h"
...
int Lufia___The_Legend_Returns__USA__main(int argc, char* argv[]) {
    ...
    GBConfig runtime_config = *Lufia___The_Legend_Returns__USA__default_config();
    ...
    if (differential_mode) {
        ...
        gb_context_set_save_id(generated_ctx, "Lufia___The_Legend_Returns__USA_");
        gb_context_set_save_id(interpreted_ctx, "Lufia___The_Legend_Returns__USA_");
        if (serial_stdout) {
            generated_ctx->callbacks.on_serial_byte = gbrt_serial_stdout;
        }
        Lufia___The_Legend_Returns__USA__init(generated_ctx, rom_data, rom_size);
        Lufia___The_Legend_Returns__USA__init(interpreted_ctx, rom_data, rom_size);
        if (data_mod_file) {
    ...
    gb_context_set_save_id(ctx, "Lufia___The_Legend_Returns__USA_");
    ...
    Lufia___The_Legend_Returns__USA__init(ctx, rom_data, rom_size);
    if (data_mod_file) {
    ...
    const GBPortMetadata port_metadata = {
        ...
        .game_id = "Lufia___The_Legend_Returns__USA_",
        .game_title = "Lufia___The_Legend_Returns__USA_",
        .rom_sha256 = "4231fd9f25a5729208475d2d6aa6c2a6e53b1e918e7731a1eee3ce532993301b",
        .rom_size = 2097152u,
    };
    ...
    Lufia___The_Legend_Returns__USA__run(ctx);
...
int main(int argc, char* argv[]) {
    return Lufia___The_Legend_Returns__USA__main(argc, argv);
}
